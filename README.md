...
│   ├── superadmin-kr7x9m.html        ← Super Admin dashboard (private, NOT linked from the home page)
│   ├── portal-ablock.html            ← A Block canteen manager portal
│   ├── portal-basil.html             ← Basil canteen manager portal
│   ├── portal-nescafe.html           ← Nescafé canteen manager portal
│   ├── portal-ccd.html               ← CCD canteen manager portal
│   ├── portal-main.html              ← Main canteen manager portal
│   └── images/                       ← Campus photos used on the home page
└── README.md
```
...
| A Block       | http://localhost:3000/portal-ablock.html       |
| Basil         | http://localhost:3000/portal-basil.html        |
| Nescafé       | http://localhost:3000/portal-nescafe.html      |
| CCD           | http://localhost:3000/portal-ccd.html          |
| Main          | http://localhost:3000/portal-main.html         |
| **Super Admin** | http://localhost:3000/superadmin-kr7x9m.html *(private — not linked anywhere on the home page)* |

> ⚠️ The Super Admin URL is intentionally kept off the home page and out of navigation. Bookmark it yourself, or share it directly with whoever needs full access. It's still protected by the manager login (`POST /api/auth/manager`) either way — the private URL just keeps it from being casually discovered.
